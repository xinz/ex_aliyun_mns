defmodule ExAliyun.MNS.Client do
  ...
  defp send_request(%{action: "CreateQueue", params: %{queue_name: queue_name} = params} = _operation, config, http_opts) do
  ...
  defp send_request(%{action: "SetQueueAttributes", params: %{queue_url: queue_url} = params}, config, http_opts) do
    body = Xml.generate_queue(params)
  ...
  defp send_request(%{action: "GetQueueAttributes", params: %{queue_url: queue_url}}, config, http_opts) do
    config
    |> new_client(http_opts)
    |> get(queue_url)
  end
  ...
  defp send_request(%{action: "SendMessage", params: %{queue_url: queue_url} = params}, config, http_opts) do
  ...
  defp send_request(%{action: "BatchSendMessage", params: %{queue_url: queue_url, messages: messages}}, config, http_opts) do
  ...
  defp send_request(%{action: "DeleteMessage", params: %{queue_url: queue_url, receipt_handle: receipt_handle}}, config, http_opts) do
    config
    |> new_client(http_opts)
    |> delete("#{queue_url}/messages", query: [{"ReceiptHandle", receipt_handle}])
  end
  defp send_request(%{action: "BatchDeleteMessage", params: %{queue_url: queue_url, receipt_handles: receipt_handles}}, config, http_opts) do
  ...
  defp send_request(%{action: "ReceiveMessage", params: %{queue_url: queue_url} = params}, config, http_opts) do
    ...
    opts = if wait_time_seconds != nil, do: [timeout: (wait_time_seconds + 2) * 1000], else: http_opts

    config
    |> new_client(opts)
    |> get("#{queue_url}/messages", query: query)
  end
  defp send_request(%{action: "PeekMessage", params: %{queue_url: queue_url} = params}, config, http_opts) do
    number = Map.get(params, :number)
  ...
  defp send_request(%{action: "ChangeMessageVisibility", params: %{queue_url: queue_url, receipt_handle: receipt_handle, visibility_timeout: visibility_timeout}}, config, http_opts) do
  ...
  defp send_request(%{action: "CreateTopic", params: %{topic_name: topic_name} = params}, config, http_opts) do
  ...
  defp send_request(%{action: "SetTopicAttributes", params: %{topic_url: topic_url} = params}, config, http_opts) do
    body = Xml.generate_topic(params)
  ...
  defp send_request(%{action: "GetTopicAttributes", params: %{topic_url: topic_url}}, config, http_opts) do
    config
    |> new_client(http_opts)
    |> get(topic_url)
  end
  ...
  defp send_request(%{action: "Subscribe", params: %{topic_url: topic_url, subscription_name: subscription_name} = params}, config, http_opts) do
  ...
  defp send_request(%{action: "SetSubscriptionAttributes", params: %{topic_url: topic_url, subscription_name: subscription_name} = params}, config, http_opts) do
    body = Xml.generate_subscription(params)
  ...
  defp send_request(%{action: "GetSubscriptionAttributes", params: %{topic_url: topic_url, subscription_name: subscription_name}}, config, http_opts) do
    config
    |> new_client(http_opts)
    |> get("#{subscription_url(topic_url, subscription_name)}")
  end
  defp send_request(%{action: "Unsubscribe", params: %{topic_url: topic_url, subscription_name: subscription_name}}, config, http_opts) do
    config
    |> new_client(http_opts)
    |> delete("#{subscription_url(topic_url, subscription_name)}")
  end
  defp send_request(%{action: "ListSubscriptions", headers: headers, params: %{topic_url: topic_url}}, config, http_opts) do
    config
    |> new_client(http_opts)
    |> get("#{topic_url}/subscriptions", headers: headers)
  end
  defp send_request(%{action: "PublishMessage", params: %{topic_url: topic_url} = params}, config, http_opts) do
